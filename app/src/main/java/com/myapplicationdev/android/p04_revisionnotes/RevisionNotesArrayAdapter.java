...
public class RevisionNotesArrayAdapter extends  ArrayAdapter<Note> {
    ...
    public RevisionNotesArrayAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Note> noteDisplay) {
        super(context, resource, noteDisplay);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvid=rowView.findViewById(R.id.textViewNoteid);
...
/*public class RevisionNotesArrayAdapter extends ArrayAdapter<Note> {
    ...
    public RevisionNotesArrayAdapter(Context context,  ArrayList<Note> notes) {
        super(context);
        this.context = context;
        this.notes = notes;
    }
